...
@section('title', 'Member ' . $kelompok->name)
...
<div class="container my-3">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('master-kelompok.member.add', ['kelompok' => $kelompok->id]) }}">
                @csrf
                <div class="row mb-3">
                    <label for="mh_gereja_id" class="col-sm-2 col-form-label">Jemaat</label>
                    <div class="col-sm-6">
                        <livewire:select-jemaat :idGereja="$kelompok->mh_gereja_id" />
                    </div>
                    <div class="col-sm-4">
                ...
                <table class="table table-sm align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @can("update", $kelompok)
                                <form method="POST" action="{{ route('master-kelompok.member.remove', ['kelompok' => $kelompok->id, 'member' => $jemaat->id]) }}">
                                    @method('DELETE')
                                    @csrf
